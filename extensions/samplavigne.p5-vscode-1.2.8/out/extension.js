...
function installP5Library(url) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!workspacePath ||
            !fs_1.existsSync(path.join(workspacePath, "index.html")) ||
            !fs_1.existsSync(path.join(workspacePath, "libraries"))) {
        ...
        for (const u of urls) {
            ...
            if (!fs_1.existsSync(dest)) {
                try {
                    yield pipeline(got_1.default.stream(u), fs_1.createWriteStream(dest));
                }
                catch (e) {
                    vscode.window.showErrorMessage("Could not download library.");
                }
            }
            let indexFileContents = fs_1.readFileSync(indexPath, "utf-8");
            ...
            if (!indexFileContents.includes(scriptTag)) {
                ...
                fs_1.writeFileSync(indexPath, indexFileContents);
            }
...
function copyTemplate(dest) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        fs_1.writeFileSync(jsconfigPath.fsPath, JSON.stringify(jsconfig, null, 2));
    });
}
